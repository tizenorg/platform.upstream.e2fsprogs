...
typedef __SS_CONST struct __attribute__ ((visibility ("default"))) _ss_request_entry {
...
typedef __SS_CONST struct __attribute__ ((visibility ("default"))) _ss_request_table {
    int version;
...
typedef struct __attribute__ ((visibility ("default"))) _ss_rp_options {	/* DEFAULT VALUES */
